...
final class PostProcessorRegistrationDelegate {
	...
	public static void registerBeanPostProcessors(
		...
		// 添加后置处理器 BeanPostProcessorChecker
		...
		for (String ppName : postProcessorNames) {
			if (beanFactory.isTypeMatch(ppName, PriorityOrdered.class)) {
				// 创建实例  CommonAnnotationBeanPostProcessor AutowiredAnnotationBeanPostProcessor
		...
		sortPostProcessors(priorityOrderedPostProcessors, beanFactory);
		// CommonAnnotationBeanPostProcessor AutowiredAnnotationBeanPostProcessor  添加到beanFactory
		...
		// 添加ApplicationListenerDetector ，删除旧的，移到处理器链末尾，用于获取代理等
